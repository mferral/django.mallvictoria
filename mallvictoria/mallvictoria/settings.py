# Django settings for mallvictoria project.
#encoding:utf-8
...
SECRET_KEY = '+!q2htig=57it9(n)hl#=#bnu@5y02c-8c#x7zwiht+t#9h5u1'
...
ROOT_URLCONF = 'mallvictoria.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'mallvictoria.wsgi.application'
...
INSTALLED_APPS = (
    ...
    'principal',
    #app para actualizar la base sin resetearla
    'django_evolution',
)
